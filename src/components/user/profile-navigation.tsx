import { ProfileSettingsOne } from "@/constants";
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  "flex justify-between font-medium border-b last:border-b-0 border-border items-center w-full px-4 py-3 text-muted-foreground cursor-pointer hover:bg-muted"
                )}
              >
