...
const selectTriggerVariants = cva(
  `
    flex w-full bg-background items-center justify-between outline-none border border-input shadow-none shadow-black/5 transition-shadow 
  ...
  `,
  {
    variants: {
      size: {
        sm: 'h-9 px-2.5 text-xs gap-1 rounded-lg',
        md: 'h-12 px-3 text-base leading-(--text-sm--line-height) gap-1 rounded-lg',
        lg: 'h-12 px-4 text-sm gap-1.5 rounded-lg',
      },
    },
    defaultVariants: {
      size: 'md',
